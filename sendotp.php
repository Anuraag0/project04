...
if(ISSET($_POST['email'])){
    ...
    if(mysqli_num_rows($rs)>0){
        ...
        $rs=mysqli_query($con,$sql)  or die (mysqli_error($con));
        header("location:otp.php?msg=otp send success!");
    }
    else{
        echo"email not found";
        header("location:sendotperr.php?msg=otp invalid otp... plz check again!");
    }
    $con->close();
}
...
<body>
    <header>
        ...
        <ul>
            ...
            <li><a class="" href="/anurag/verify1.php">schedule</a></li>
            <li><a href="rates.php">scrap rates</a></li>
            <li style="float:right"><a class="active" href="otp.php">admin</a></li>
          </ul>
    </header>
    ...
    <div class="show">
      ...
      <div class="input-box">
             <input type="text" name="email" id="email" placeholder="email" required></div>
                ...
                <button type="submit" class="button button-dark"><strong>submit</strong></button>
            </form>
        </div>
        </div>
    <footer>
